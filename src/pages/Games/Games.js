...
const styles = {
    ...
    gameCardBody: {
        ...
        alignItems: 'center' , 
        backdropFilter: 'blur(10px)',border:'0'
    }
        ...
        <div className="games-div">
            <div className='description'>
                ...
                <div className='text-content'>
                    <div className='text'>
                        <h1> Now you can get insight of your game with this AI powered tool</h1><br></br>
                    </div>
                    <div className='game-cards'>
                        <Card className="text-center" style={styles.card}>
                            {/* <img src={sentiment} className='img2' alt='astronut'/> */}
                            <Card.Img variant="top" src={sentiment} style={styles.cardImage}/>
                            <Card.Body>
                        ...
                        <Card className="text-center" style={styles.card}>
                            {/* <img src={sentiment} className='img2' alt='astronut'/> */}
                            <Card.Img variant="top" src={controllers} style={styles.cardImage}/>
                            <Card.Body>
                        ...
                        <Card className="text-center" style={styles.card}>
                            {/* <img src={sentiment} className='img2' alt='astronut'/> */}
                            <Card.Img variant="top" src={benchmark} style={styles.cardImage}/>
                            <Card.Body>
            ...
            <div className='games-class'>
                    <div className="games-list">
                        <Card style={styles.gameCard}>
                            <img
                            src={counterStrike} class="card-img-top" alt=""  style={styles.gameCardImg}/>
                            <Card.Body style={styles.gameCardBody}>
                                <h5 class="card-title-new">Counter Strike</h5>
                                <button id ='10' class="button"  style={{verticalAlign:"middle"}}><span>Click Me! </span></button>
                            </Card.Body>
                        </Card>
                        <Card style={styles.gameCard}>
                            <img
